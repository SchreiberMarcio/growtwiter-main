...
export class User {
  ...
  constructor(
    ...
    this.validateData(); // Valida os dados no momento da criação do usuário
  }
  ...
  // Não exponha diretamente a senha
  ...
  public sendTweet(newTweet: Tweet): void {
    ...
    this._tweets.push(newTweet); // Adiciona o tweet também ao histórico do usuário
  }
